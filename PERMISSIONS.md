...
- **INTERNET** - download offline maps and routing data, check GitHub for a newer app version and download it, plus send the SRT screen stream to your own server.
...
- **WRITE_EXTERNAL_STORAGE** (maxSdkVersion 28) - save the downloaded app-update APK to the public Downloads folder on Android 9 and older (newer Android needs no permission for this).
